...
namespace NTagReader
{
    class CardReader
    {
        [DllImport("IDReader.dll", EntryPoint = "RegisterHidDeviceNotify")]
        public static extern int RegisterHidDeviceNotify(int hWnd);

        [DllImport("IDReader.dll", EntryPoint = "LIB_GetVer")]
        public static extern int GetVer(int ver);

        [DllImport("IDReader.dll", EntryPoint = "DEV_OpenReader")]
        public static extern int OpenReader();

        [DllImport("IDReader.dll", EntryPoint = "DEV_CloseReader")]
        public static extern int CloseReader();

        [DllImport("IDReader.dll", EntryPoint = "DEV_SetAutoRead")]
        public static extern int SetAutoRead(byte mode);

        [DllImport("IDReader.dll", EntryPoint = "DEV_SetLed")]
        public static extern int SetLed(byte color);

        [DllImport("uFCoder-x86_64.dll", CallingConvention = CallingConvention.StdCall, EntryPoint = "GetDllVersion")]
        ...
        public static extern Boolean SetupDiEnumDeviceInterfaces(IntPtr hDevInfo, IntPtr devInfo, ref Guid interfaceClassGuid,
